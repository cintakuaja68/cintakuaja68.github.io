...
function getMovieInfo() {
  $.ajax({
    ...
    success: function (data) {
      ...
      var originalLanguage =
        languageMappings[data.original_language] ||
        data.original_language ||
        "N/A";
      var productionCountries =
        data.production_countries
          .map((country) => countryMappings[country.name] || country.name)
          .join(", ") ||
  ...
  <div class="media-body">
    ...
    <span><a href="https://www.themoviedb.org/movie/${tmdbId}" target="_blank">themoviedb.org</a></span>
      ...
      var homepage = data.homepage || "Not available";
      ...
      $.ajax({
        ...
        success: function (releaseData) {
          ...
          $("#poster-container").html(`
                <img class='poster' src='${posterUrl}' title='${title}' alt='${title} Poster'>
      ...
      $("#movie-details").html(`
        <table id="movie-details">
          ...
          <tr>
           ...
           <tr>
            <td class="title">country, lang</td>
            <td class="titik2">:</td>
            <td class="info">${productionCountries} <span class="span-lang">(${originalLanguage})</span></td>
          </tr>
         <tr>
          <tr>
